...
public class ProcessorImaging {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<String, Map<String, BufferedImage>> bufferedImageMap = new HashMap<>();
...
//                Map<String, Double> cMCPMap = new HashMap<String, Double>();
                ...
                for (int j = 0; j < trainM.length; j++) {
                    ...
                    Map<String, BufferedImage> imageBMap = bufferedImageMap.get(categoryName);

                    if (imageBMap == null) {
                        imageBMap = new HashMap<>();

                        bufferedImageMap.put(categoryName, imageBMap);
                    }
...
//                    double totalSimilarityValue = 0.0;
                    ...
                    for (int k = 0; k < trainC.length; k++) {
                        ...
                        BufferedImage trainB = imageBMap.get(trainI.getName());

                        if (trainB == null) {
                            trainB = ImageIO.read(trainI);

//                            if (jj < 47000) {
                            imageBMap.put(trainI.getName(), trainB);
