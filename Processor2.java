...
//                Map<String, Double> cMCPMap = new HashMap<String, Double>();
                ...
                for (int j = 0; j < trainM.length; j++) {
                    ...
                    Map<String, BufferedImage> m = bufferedImageMap.get(categoryName);
...
//                    double totalSimilarityValue = 0.0;
                    ...
                    for (int k = 0; k < trainC.length; k++) {
                        ...
                        BufferedImage trainB = m.get(trainI.getName());

                        if (trainB == null) {
                            trainB = ImageIO.read(trainI);
                            m.put(categoryName, trainB);
                        }
                        ...
                        execute.submit(new CustomRunnableTemp(metric, img1, trainB, latch));
